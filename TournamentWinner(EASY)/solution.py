...
# competition, one team is designed the home team, while the other team is away
# team. In each competition there's always one winner and one loser; there are
# no ties. A team recevies 3 points if it wins and 0 points if it loses. The
...
# the winner of each corresponding competition in the competitions array. Specifically,
...
# will compete against all other teams exactly once. It's also guatanteed that the
# tournament will always have at least two teams.


# space: O(k) no of teams
# time: O(n)
